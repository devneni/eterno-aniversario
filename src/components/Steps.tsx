...
const Steps: FC = () => {
  ...
  const stepsData = [
    { 
      icon: ListChecks, 
      text: t('firststep'),
      description: t('descriptionfirststep') 
    },
    { 
      icon: Calendar, 
      text: t('secondstep'), 
      description: t('descriptionsecondstep') 
    },
    { 
      icon: Image, 
      text: t('thirdstep'), 
      description: t('descriptionthirdstep') 
    },
    { 
      icon: Music, 
      text: t('fourthstep'), 
      description: t('descriptionfourthstep') 
    },
    { 
      icon: CreditCard, 
      text: t('fifthstep'),
      description: t('descriptionfifthstep') 
    },
  ];
