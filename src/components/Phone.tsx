...
function Phone({
  ...
  useEffect(() => {
    // Gerar corações iniciais - agora sempre ativos, independente de ter imagens
  ...
  }, []); // Removida a dependência de files.length e savedImages.length
  ...
  return (
    <div 
      className="border-12 p-4 w-[320px] rounded-[45px] mt-50 border-[#484d52] h-150 overflow-y-auto esconde-scroll mb-15 relative"
      style={{ 
        background: getBackgroundStyle(backgroundColor),
      }}
    >
      {/* Camada de corações caindo em toda a div */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-[45px] z-50">
